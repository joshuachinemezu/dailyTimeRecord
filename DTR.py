def readDTR(path):
    ...
    # path = "/home/jvfiel/Documents/SOYAN/cyberbeeDTR/001_GLog.txt"

    # book = pe.get_book(file_name=path)
    # sheets = book.to_dict()
    # no_item_code = []
    # for sheet_name in sheets.keys():
    #     master_sheet = book[sheet_name]
    #     for i, row in enumerate(master_sheet):
    #         print row
    #         # if i == 0:
    #         #     continue
    ...
    #     for each_line in fileinput.input(path):
